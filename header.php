...
<!--[if (gte IE 9)|(gt IEMobile 7)|!(IEMobile)|!(IE)]><!--><html <?php language_attributes(); ?> class="no-js"><!--<![endif]-->
   ...
   <head>
      <!-- RFN Commented out..not sure of usage <head profile="http://gmpg.org/xfn/11">-->
      <link rel="icon" type="image/png" href="http://localhost/webhedron/wp-content/uploads/2013/07/WebHedron-Logo-Favicon_03.png">
      <meta charset="utf-8">
      ...
      <!--RFN Commented out <link rel="pingback" href="<?php bloginfo('pingback_url'); ?>"-->
      ...
      <!-- typeahead plugin - if top nav search bar enabled -->
		<?php require_once(get_template_directory() . "/../wp-bootstrap/library/typeahead.php"); ?>
   </head>
